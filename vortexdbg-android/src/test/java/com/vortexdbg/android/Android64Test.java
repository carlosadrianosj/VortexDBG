...
public class Android64Test extends AbstractJni {
    ...
    private Android64Test() {
        final File executable = new File("vortexdbg-android/src/test/native/android/libs/arm64-v8a/test");
        ...
        vm.setVerbose(true);
        vm.setJni(this);
        DalvikModule dm = vm.loadLibrary(new File("vortexdbg-android/src/test/native/android/libs/arm64-v8a/libnative.so"), false);
