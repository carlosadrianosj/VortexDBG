...
import com.vortexdbg.virtualmodule.android.SystemProperties;
...
public class AndroidTest extends AbstractJni {
    ...
    private AndroidTest() {
        final File executable = new File("vortexdbg-android/src/test/native/android/libs/armeabi-v7a/test");
        ...
        vm.setVerbose(true);
        vm.setJni(this);
        DalvikModule dm = vm.loadLibrary(new File("vortexdbg-android/src/test/native/android/libs/armeabi-v7a/libnative.so"), true);
    ...
    private void test() {
        ...
        Logger.getLogger("com.vortexdbg.linux.AndroidSyscallHandler").setLevel(Level.INFO);
