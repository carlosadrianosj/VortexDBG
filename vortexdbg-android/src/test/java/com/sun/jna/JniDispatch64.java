...
import com.vortexdbg.hook.hookzz.Dobby;
import com.vortexdbg.hook.hookzz.HookEntryInfo;
import com.vortexdbg.hook.hookzz.IHookZz;
import com.vortexdbg.hook.hookzz.InstrumentCallback;
import com.vortexdbg.hook.whale.IWhale;
import com.vortexdbg.hook.whale.Whale;
...
public class JniDispatch64 {
    ...
    private JniDispatch64() {
        ...
        vm.setVerbose(true);
        DalvikModule dm = vm.loadLibrary(new File("vortexdbg-android/src/test/resources/example_binaries/arm64-v8a/libjnidispatch.so"), false);
    ...
    private void test() {
        ...
        Pointer pointer = VortexdbgPointer.pointer(emulator, ret.intValue() & 0xffffffffL);
        assert pointer != null;
