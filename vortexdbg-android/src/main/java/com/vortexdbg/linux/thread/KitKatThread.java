...
public class KitKatThread extends ThreadTask {
    ...
    private final VortexdbgPointer child_stack;
    private final VortexdbgPointer fn;
    private final VortexdbgPointer arg;

    public KitKatThread(int tid, long until, VortexdbgPointer child_stack, VortexdbgPointer fn, VortexdbgPointer arg) {
        super(tid, until);
    ...
    protected Number runThread(AbstractEmulator<?> emulator) {
        ...
        VortexdbgPointer stack = allocateStack(emulator);
