...
public class DalvikVM64 extends BaseVM implements VM {
    ...
    private final VortexdbgPointer _JavaVM;
    private final VortexdbgPointer _JNIEnv;
    ...
    public DalvikVM64(AndroidEmulator emulator, File apkFile) {
        ...
        Pointer _ToReflectedMethod = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer clazz = context.getPointerArg(1);
                VortexdbgPointer jmethodID = context.getPointerArg(2);
        ...
        Pointer _Throw = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer object = context.getPointerArg(1);
        ...
        Pointer _PopLocalFrame = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer jresult = context.getPointerArg(1);
                if (log.isDebugEnabled()) {
        ...
        Pointer _IsSameObject = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer ref1 = context.getPointerArg(1);
                VortexdbgPointer ref2 = context.getPointerArg(2);
                if (log.isDebugEnabled()) {
        ...
        Pointer _NewObjectV = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer clazz = context.getPointerArg(1);
                VortexdbgPointer jmethodID = context.getPointerArg(2);
                VortexdbgPointer va_list = context.getPointerArg(3);
                DvmClass dvmClass = classMap.get(clazz.toIntPeer());
                DvmMethod dvmMethod = dvmClass == null ? null : dvmClass.getMethod(jmethodID.toIntPeer());
                if (log.isDebugEnabled()) {
        ...
        Pointer _NewObjectA = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer clazz = context.getPointerArg(1);
                VortexdbgPointer jmethodID = context.getPointerArg(2);
                VortexdbgPointer jvalue = context.getPointerArg(3);
                DvmClass dvmClass = classMap.get(clazz.toIntPeer());
                DvmMethod dvmMethod = dvmClass == null ? null : dvmClass.getMethod(jmethodID.toIntPeer());
                if (log.isDebugEnabled()) {
        ...
        Pointer _IsInstanceOf = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer clazz = context.getPointerArg(2);
                DvmObject<?> dvmObject = getObject(object.toIntPeer());
                if (clazz == null) {
                    throw new IllegalStateException("LR=" + context.getLRPointer());
                }
        ...
        Pointer _CallNonvirtualBooleanMethodA = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer clazz = context.getPointerArg(2);
                VortexdbgPointer jmethodID = context.getPointerArg(3);
                VortexdbgPointer jvalue = context.getPointerArg(4);
                if (log.isDebugEnabled()) {
        ...
        Pointer _CallNonvirtualVoidMethodV = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer clazz = context.getPointerArg(2);
                VortexdbgPointer jmethodID = context.getPointerArg(3);
                VortexdbgPointer va_list = context.getPointerArg(4);
                if (log.isDebugEnabled()) {
        ...
        Pointer _GetFieldID = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer clazz = context.getPointerArg(1);
                VortexdbgPointer fieldName = context.getPointerArg(2);
                Pointer argsPointer = context.getPointerArg(3);
        ...
        Pointer _GetObjectField = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer jfieldID = context.getPointerArg(2);
                if (log.isDebugEnabled()) {
        ...
        Pointer _SetObjectField = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer jfieldID = context.getPointerArg(2);
                VortexdbgPointer value = context.getPointerArg(3);
                if (log.isDebugEnabled()) {
        ...
        Pointer _GetStaticLongField = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer clazz = context.getXPointer(1);
                VortexdbgPointer jfieldID = context.getXPointer(2);
                if (log.isDebugEnabled()) {
        ...
        Pointer _GetStringUTFChars = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer isCopy = context.getPointerArg(2);
                ...
                VortexdbgPointer pointer = string.allocateMemoryBlock(emulator, data.length);
        ...
        Pointer _ReleaseStringUTFChars = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer pointer = context.getPointerArg(2);
                StringObject string = getObject(object.toIntPeer());
                if (verbose) {
        ...
        Pointer _GetArrayLength = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer pointer = context.getPointerArg(1);
        ...
        Pointer _NewObjectArray = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer elementClass = context.getPointerArg(2);
                VortexdbgPointer initialElement = context.getPointerArg(3);
                if (log.isDebugEnabled()) {
        ...
        Pointer _SetObjectArrayElement = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer object = context.getPointerArg(1);
                int index = context.getIntArg(2);
                VortexdbgPointer element = context.getPointerArg(3);
                ArrayObject array = getObject(object.toIntPeer());
        ...
        Pointer _GetByteArrayElements = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer arrayPointer = context.getPointerArg(1);
        ...
        Pointer _NewString = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer unicodeChars = context.getPointerArg(1);
        ...
        Pointer _NewStringUTF = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer bytes = context.getPointerArg(1);
                if (bytes == null) {
                    return VM.JNI_NULL;
                }
        ...
        Pointer _RegisterNatives = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                for (int i = 0; i < nMethods; i++) {
                    ...
                    dvmClass.nativesMap.put(methodName + signatureValue, (VortexdbgPointer) fnPtr);
        ...
        Pointer _GetJavaVM = svcMemory.registerSvc(new Arm64Svc() {
            ...
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                VortexdbgPointer vm = context.getPointerArg(1);
                if (log.isDebugEnabled()) {
        ...
        final VortexdbgPointer impl = svcMemory.allocate(last + 8, "JNIEnv.impl");
        ...
        VortexdbgPointer _DestroyJavaVM = svcMemory.registerSvc(new Arm64Svc() {
            @Override
            public long handle(Emulator<?> emulator) {
                throw new UnsupportedOperationException();
            }
        });
        VortexdbgPointer _AttachCurrentThread = svcMemory.registerSvc(new Arm64Svc() {
            @Override
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
        ...
        VortexdbgPointer _DetachCurrentThread = svcMemory.registerSvc(new Arm64Svc() {
            @Override
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                Pointer vm = context.getPointerArg(0);
        ...
        VortexdbgPointer _GetEnv = svcMemory.registerSvc(new Arm64Svc() {
            @Override
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                Pointer vm = context.getPointerArg(0);
        ...
        VortexdbgPointer _AttachCurrentThreadAsDaemon = svcMemory.registerSvc(new Arm64Svc() {
            @Override
            public long handle(Emulator<?> emulator) {
                throw new UnsupportedOperationException();
            }
        ...
        VortexdbgPointer _JNIInvokeInterface = svcMemory.allocate(emulator.getPointerSize() * 8, "_JNIInvokeInterface");
