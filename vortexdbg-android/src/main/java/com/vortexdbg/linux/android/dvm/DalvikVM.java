    ...
    public DalvikVM(AndroidEmulator emulator, File apkFile) {
        ...
        Pointer _SetLongField = svcMemory.registerSvc(new ArmSvc() {
            ...
            public long handle(Emulator<?> emulator) {
                ...
                VortexdbgPointer object = context.getPointerArg(1);
                VortexdbgPointer jfieldID = context.getPointerArg(2);
                VortexdbgPointer sp = context.getStackPointer();
        ...
        final VortexdbgPointer impl = svcMemory.allocate(last + 4, "JNIEnv.impl");
        ...
        VortexdbgPointer _AttachCurrentThread = svcMemory.registerSvc(new ArmSvc() {
            @Override
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
        ...
        VortexdbgPointer _GetEnv = svcMemory.registerSvc(new ArmSvc("_GetEnv") {
            @Override
            public long handle(Emulator<?> emulator) {
                RegisterContext context = emulator.getContext();
                Pointer vm = context.getPointerArg(0);
