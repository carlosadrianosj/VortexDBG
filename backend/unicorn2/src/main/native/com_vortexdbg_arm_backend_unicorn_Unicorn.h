...
#include <jni.h>
/* Header for class com_vortexdbg_arm_backend_unicorn_Unicorn */

#ifndef _Included_com_vortexdbg_arm_backend_unicorn_Unicorn
#define _Included_com_vortexdbg_arm_backend_unicorn_Unicorn
#ifdef __cplusplus
extern "C" {
#endif
/*
