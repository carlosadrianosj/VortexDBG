...
#include <jni.h>
/* Header for class com_vortexdbg_arm_backend_kvm_Kvm */

#ifndef _Included_com_vortexdbg_arm_backend_kvm_Kvm
#define _Included_com_vortexdbg_arm_backend_kvm_Kvm
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_vortexdbg_arm_backend_kvm_Kvm_free
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_vortexdbg_arm_backend_kvm_Kvm_context_1alloc
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_vortexdbg_arm_backend_kvm_Kvm_context_1save
  (JNIEnv *, jclass, jlong, jlong);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_vortexdbg_arm_backend_kvm_Kvm_context_1restore
  (JNIEnv *, jclass, jlong, jlong);
