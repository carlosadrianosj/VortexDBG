...
#include <jni.h>
/* Header for class com_vortexdbg_arm_backend_dynarmic_Dynarmic */

#ifndef _Included_com_vortexdbg_arm_backend_dynarmic_Dynarmic
#define _Included_com_vortexdbg_arm_backend_dynarmic_Dynarmic
#ifdef __cplusplus
extern "C" {
#endif
/*
