...
#include <jni.h>
/* Header for class com_vortexdbg_arm_backend_HypervisorFactory */

#ifndef _Included_com_vortexdbg_arm_backend_HypervisorFactory
#define _Included_com_vortexdbg_arm_backend_HypervisorFactory
#ifdef __cplusplus
extern "C" {
#endif
/*
