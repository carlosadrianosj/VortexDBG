...
import com.vortexdbg.ios.ipa.NSUserDefaultsResolver;
...
//         emulator.traceCode();
        ...
        start = System.currentTimeMillis();
        Logger.getLogger("com.vortexdbg.ios.debug").setLevel(Level.INFO);
        Logger.getLogger("com.vortexdbg.thread").setLevel(Level.INFO);
        Logger.getLogger("com.vortexdbg.ios.kevent").setLevel(Level.INFO);
