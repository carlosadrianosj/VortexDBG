...
import com.vortexdbg.ios.struct.kernel.HostRequestNotificationReply;
import com.vortexdbg.ios.struct.kernel.HostRequestNotificationRequest;
...
import com.vortexdbg.ios.struct.kernel.MachPortsLookupReply32;
...
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterCheckRequest;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterMachPortReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterMachPortRequest;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterPlainReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterPlainRequest;
import com.vortexdbg.ios.struct.kernel.ProcBsdShortInfo;
import com.vortexdbg.ios.struct.kernel.Pthread;
import com.vortexdbg.ios.struct.kernel.Pthread32;
...
import com.vortexdbg.ios.struct.kernel.Stat;
...
import com.vortexdbg.ios.struct.kernel.ThreadStateReply32;
import com.vortexdbg.ios.struct.kernel.ThreadStateRequest;
import com.vortexdbg.ios.struct.kernel.VmCopyReply;
import com.vortexdbg.ios.struct.kernel.VmCopyRequest;
import com.vortexdbg.ios.struct.kernel.VmRegionRecurse32Reply;
import com.vortexdbg.ios.struct.kernel.VmRegionRecurse32Request;
import com.vortexdbg.ios.struct.kernel.VmRegionReply;
import com.vortexdbg.ios.struct.kernel.VmRegionRequest;
import com.vortexdbg.ios.struct.kernel.VmRemapReply;
import com.vortexdbg.ios.struct.kernel.VmRemapRequest;
import com.vortexdbg.ios.struct.sysctl.IfMsgHeader;
import com.vortexdbg.ios.struct.sysctl.KInfoProc32;
import com.vortexdbg.ios.struct.sysctl.SockAddrDL;
import com.vortexdbg.ios.struct.sysctl.TaskDyldInfo;
...
import static com.vortexdbg.ios.file.SocketIO.AF_LINK;
import static com.vortexdbg.ios.file.SocketIO.AF_ROUTE;
        ...
        switch (top) {
            case CTL_UNSPEC: {
                ...
                if (action == 3) {
                    ...
                    switch (sub) {
                        case "unidbg.debug":
                            return LoggerFactory.getLogger("com.vortexdbg.ios.debug").isDebugEnabled() ? 1 : 0;
                        case "kern.ostype":
