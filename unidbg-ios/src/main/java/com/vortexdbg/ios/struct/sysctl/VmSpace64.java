package com.vortexdbg.ios.struct.sysctl;
...
public class VmSpace64 extends UnidbgStructure {

    public VmSpace64(Pointer p) {
        super(p);
    }

    public int vm_refcnt; /* number of references */
    public long vm_shm; /* SYS5 shared memory private data XXX */
    ...
    public long vm_taddr; /* user virtual address of text XXX */
    public long vm_daddr; /* user virtual address of data XXX */
    public long vm_maxsaddr; /* user VA at max stack growth */
