...
import com.vortexdbg.file.ios.IOConstants;
import com.vortexdbg.ios.file.ByteArrayFileIO;
import com.vortexdbg.ios.file.DriverFileIO;
import com.vortexdbg.ios.file.LocalDarwinUdpSocket;
import com.vortexdbg.ios.file.SocketIO;
import com.vortexdbg.ios.file.TcpSocket;
import com.vortexdbg.ios.file.UdpSocket;
import com.vortexdbg.ios.struct.attr.AttrList;
import com.vortexdbg.ios.struct.kernel.AslServerMessageRequest;
import com.vortexdbg.ios.struct.kernel.ClockGetTimeReply;
import com.vortexdbg.ios.struct.kernel.DyldCacheHeader;
import com.vortexdbg.ios.struct.kernel.HostGetClockServiceReply;
import com.vortexdbg.ios.struct.kernel.HostGetClockServiceRequest;
import com.vortexdbg.ios.struct.kernel.HostInfoReply;
import com.vortexdbg.ios.struct.kernel.HostInfoRequest;
import com.vortexdbg.ios.struct.kernel.IOServiceAddNotificationRequest;
import com.vortexdbg.ios.struct.kernel.IOServiceGetMatchingServiceRequest;
import com.vortexdbg.ios.struct.kernel.MachMsgHeader;
import com.vortexdbg.ios.struct.kernel.MachPortOptions;
import com.vortexdbg.ios.struct.kernel.MachPortReply;
import com.vortexdbg.ios.struct.kernel.MachPortSetAttributesReply;
import com.vortexdbg.ios.struct.kernel.MachPortSetAttributesRequest;
import com.vortexdbg.ios.struct.kernel.MachPortTypeReply;
import com.vortexdbg.ios.struct.kernel.MachPortTypeRequest;
import com.vortexdbg.ios.struct.kernel.MachPortsLookupReply64;
import com.vortexdbg.ios.struct.kernel.MachTimebaseInfo;
import com.vortexdbg.ios.struct.kernel.MachVmMapReply;
import com.vortexdbg.ios.struct.kernel.MachVmMapRequest;
import com.vortexdbg.ios.struct.kernel.MakeMemoryEntryReply;
import com.vortexdbg.ios.struct.kernel.MakeMemoryEntryRequest;
import com.vortexdbg.ios.struct.kernel.NotifyServerCancelReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerCancelRequest;
import com.vortexdbg.ios.struct.kernel.NotifyServerGetStateReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerGetStateRequest;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterCheck64Request;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterCheckReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterMachPort64Request;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterMachPortReply;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterPlain64Request;
import com.vortexdbg.ios.struct.kernel.NotifyServerRegisterPlainReply;
import com.vortexdbg.ios.struct.kernel.ProcBsdShortInfo;
import com.vortexdbg.ios.struct.kernel.Pthread;
import com.vortexdbg.ios.struct.kernel.Pthread64;
import com.vortexdbg.ios.struct.kernel.PurgableControlReply;
import com.vortexdbg.ios.struct.kernel.PurgableControlRequest;
import com.vortexdbg.ios.struct.kernel.RLimit;
import com.vortexdbg.ios.struct.kernel.RUsage64;
import com.vortexdbg.ios.struct.kernel.SemaphoreCreateReply;
import com.vortexdbg.ios.struct.kernel.SemaphoreCreateRequest;
import com.vortexdbg.ios.struct.kernel.Stat64;
import com.vortexdbg.ios.struct.kernel.StatFS;
import com.vortexdbg.ios.struct.kernel.TaskBasicInfoReply64V2;
import com.vortexdbg.ios.struct.kernel.TaskDyldInfoReply;
import com.vortexdbg.ios.struct.kernel.TaskGetExceptionPortsReply;
import com.vortexdbg.ios.struct.kernel.TaskGetExceptionPortsRequest;
import com.vortexdbg.ios.struct.kernel.TaskGetSpecialPortReply;
import com.vortexdbg.ios.struct.kernel.TaskGetSpecialPortRequest;
import com.vortexdbg.ios.struct.kernel.TaskInfoRequest;
import com.vortexdbg.ios.struct.kernel.TaskSetExceptionPortsReply;
import com.vortexdbg.ios.struct.kernel.TaskSetExceptionPortsRequest;
import com.vortexdbg.ios.struct.kernel.TaskThreadsReply64;
import com.vortexdbg.ios.struct.kernel.TaskVmInfoReply64;
import com.vortexdbg.ios.struct.kernel.ThreadBasicInfoReply;
import com.vortexdbg.ios.struct.kernel.ThreadInfoRequest;
import com.vortexdbg.ios.struct.kernel.ThreadStateReply64;
import com.vortexdbg.ios.struct.kernel.ThreadStateRequest;
import com.vortexdbg.ios.struct.kernel.VmCopy64Request;
import com.vortexdbg.ios.struct.kernel.VmCopyReply;
import com.vortexdbg.ios.struct.kernel.VmReadOverwriteReply;
import com.vortexdbg.ios.struct.kernel.VmReadOverwriteRequest;
import com.vortexdbg.ios.struct.kernel.VmRegion64Reply;
import com.vortexdbg.ios.struct.kernel.VmRegion64Request;
import com.vortexdbg.ios.struct.kernel.VmRegionRecurse64Reply;
import com.vortexdbg.ios.struct.kernel.VmRegionRecurse64Request;
import com.vortexdbg.ios.struct.kernel.VmRemapReply;
import com.vortexdbg.ios.struct.kernel.VmRemapRequest;
import com.vortexdbg.ios.struct.sysctl.*;
...
import static com.vortexdbg.file.ios.DarwinFileIO.XATTR_CREATE;
import static com.vortexdbg.file.ios.DarwinFileIO.XATTR_REPLACE;
import static com.vortexdbg.ios.MachO.MAP_MY_FIXED;
import static com.vortexdbg.ios.file.SocketIO.*;
...
public class ARM64SyscallHandler extends DarwinSyscallHandler {
        ...
        switch (top) {
            case CTL_UNSPEC: {
                ...
                if (action == 3) {
                    ...
                    switch (sub) {
                        case "unidbg.debug":
                            return verbose || LoggerFactory.getLogger("com.vortexdbg.ios.debug").isDebugEnabled() ? 1 : 0;
                        case "kern.ostype":
    ...
    private int _kernelrpc_mach_vm_deallocate_trap(Emulator<?> emulator) {
        ...
        if (log.isDebugEnabled()) {
            ...
            Logger log = LoggerFactory.getLogger("com.vortexdbg.ios.malloc");
            if (log.isDebugEnabled()) {
    ...
    private long mmap(Emulator<?> emulator) {
        ...
        } else if (LoggerFactory.getLogger("com.vortexdbg.ios.malloc").isDebugEnabled()) {
            log.debug(msg);
        }
        return base;
    }
