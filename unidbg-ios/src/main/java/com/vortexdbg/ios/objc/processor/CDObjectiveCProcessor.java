...
import com.vortexdbg.ios.ExportSymbol;
...
public abstract class CDObjectiveCProcessor implements ObjectiveCProcessor {
    ...
    public Symbol findObjcSymbol(Symbol bestSymbol, long targetAddress, MachOModule module) {
        ...
        if (objc2Method != null) {
            ...
            return new ExportSymbol(symbolName, module.base + objc2Method.getImp(), module, 0, com.vortexdbg.ios.MachO.EXPORT_SYMBOL_FLAGS_KIND_ABSOLUTE);
        }
        return null;
    }
