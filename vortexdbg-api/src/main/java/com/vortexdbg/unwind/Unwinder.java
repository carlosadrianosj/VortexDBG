...
public abstract class Unwinder {
    ...
    public abstract Frame createFrame(VortexdbgPointer ip, VortexdbgPointer fp);
    ...
    private void printFrameElement(String maxLengthSoName, Memory memory, VortexdbgPointer ip) {
