...
public abstract class AbstractEmulator<T extends NewFileIO> implements Emulator<T>, MemoryWriteListener {
    ...
    public AbstractEmulator(boolean is64Bit, String processName, long svcBase, int svcSize, File rootDir, Family family, Collection<BackendFactory> backendFactories) {
        ...
        this.processName = processName == null ? "vortexdbg" : processName;
    ...
    private void notifyMcpExecutionStarted(long address) {
        if (debugger instanceof com.vortexdbg.arm.AbstractARMDebugger) {
            ((com.vortexdbg.arm.AbstractARMDebugger) debugger).notifyExecutionStarted(address);
        }
    }
    ...
    public final Number emulate(long begin, long until) throws PopContextException {
        ...
        final Pointer pointer = VortexdbgPointer.pointer(this, begin);
        long start = 0;
    ...
    public String getProcessName() {
        return processName == null ? "vortexdbg" : processName;
    }
