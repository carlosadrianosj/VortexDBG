...
public abstract class BaseTask implements RunnableTask {
    ...
    protected final Number continueRun(AbstractEmulator<?> emulator, long until) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("continue run task={}, pc={}, until=0x{}", this, VortexdbgPointer.pointer(emulator, pc), Long.toHexString(until));
        }
    ...
    protected final VortexdbgPointer allocateStack(Emulator<?> emulator) {
