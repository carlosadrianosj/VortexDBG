...
public abstract class VirtualModule<T> {
    ...
    private final Map<String, VortexdbgPointer> symbols = new HashMap<>();
    ...
    protected abstract void onInitialize(Emulator<?> emulator, T extra, Map<String, VortexdbgPointer> symbols);
