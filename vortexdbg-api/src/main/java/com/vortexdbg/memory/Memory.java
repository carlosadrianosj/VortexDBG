...
public interface Memory extends IO, Loader, StackMemory {
    ...
    VortexdbgPointer allocateThreadStack(int index);
    VortexdbgPointer allocateStack(int size);
    VortexdbgPointer pointer(long address);
    ...
    VortexdbgPointer mmap(int length, int prot);
